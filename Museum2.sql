...
constraint SFK foreign key (obj_ID) references ART_OBJECT(obj_ID));
...
values 	('90001', 'Cecily Brown', '2023-12-03', '2023-12-10'), -- Other
		('90002', 'Manet Degas', '2023-12-11', '2023-12-18'), -- Painting
        ('90003', 'Africa & Byzantium', '2023-12-19', '2023-12-27'), -- Statue
		('90004', 'Tentacrome', '202-11-30', 'Ongoing'); -- Sculpture
...
values  ('10001', 'Martyrdom of the 7', 'A narrative of religious persecution.', 1530, 'Flemish', 'Renaissance', 'Fletcher Collection', 'Dirck Vellert', '90001'),
        ...
        ('10003', 'The Death of Dave', 'Showcases the last moments of St.Dave.', 1250, 'Greek', 'Medieval', 'Brown Collection', 'Alexander Antacoumpo', '90002'),
        ('10004', 'The Victory of Valhalla', 'Displays the warriors of Valhalla', 793, 'Scandavavian', 'Viking Age', 'Brown Collection', null, '90002'),
        ('10005', 'The Statue of Eren', 'A leading Monarch for the People.', 1790, 'Japanese', 'Industrial', 'Taisho Collection', null, '90003'),
        ('10006', 'The Statue of Alexander the Great', 'King of Macedon', 320, 'Greek', 'Ancient', 'Contrast Collection', null, '90003'),
        ('10007', 'The Bust of Nefertiti', 'Great Royal Wife of Egyptian pharaoh Akhenaten', 350, 'Egypt', 'Ancient', 'Contrast Collection', 'Thutmoze', '90004'),
		('10008', 'Guitar', 'An instrument of great influence.', 1910, 'Spain', 'Machine Age', 'Taisho Collection', null, '90004');
...
values  ('Fletcher Collection', 'Museum', 'Collection of pieces regarding personal interests.', '731 Fondren, Houston TX', '111-222-3333', 'James Fletcher'),
		('Brown Collection', 'Museum', 'Collection of pieces regarding past wars.', '291 Berry, Bellaire TX', '222-333-4444', 'Bruce Brown'),
        ('Taisho Collection', 'Personal', 'Collection of pieces regarding music and Monarchs', '5631 Rice, Houston TX', '333-444-5555', 'Nick Suzuki'),
        ('Contrast Collection', 'Personal', 'Collection of pieces regarding Ancient Times', '980 Dallas, Houston TX', '444-555-6666', 'Henry Bucklemore');
...
values  ('Fletcher Collection', 'On Display', '30000', '2002-08-19'),
		('Brown Collection', 'Stored', '81500', '2010-03-10');

insert into ARTIST
values  ('Dirck Vellert', 'World-Renouned Artist of the Renaissance', '1489-05-04', '1559-12-03', 'Belgium', 'Futurism', 'Renaissance'),
		('David Schwartz', 'Small German Artist of the Renaissance', null, null, 'Germany', 'Rococo', 'Renaissance'),
        ('Alexander Antacoumpo', 'Famed Painter of the Medieval times', '1220-02-24', '1287-01-31', 'Greece', 'Classicism', 'Medieval'),
        ('Thutmoze', null, null, null, 'Egypt', 'Symbolism', 'Medieval');
