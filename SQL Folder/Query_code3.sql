...
-- Query 5: 
-- A query that displays the cost of the 'Brown Collection' by going through the ART_OBJECT table and using only ONE object and
-- JOINING it with the PERMANENT_COLLECTION table. 
